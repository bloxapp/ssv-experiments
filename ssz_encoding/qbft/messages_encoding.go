...
// Hash: 7575ee019cbcfd826fed7e2ff8f8c45cc3bf8c33bd2203b7ee5b6dcc1fc692d2
package qbft
...
func (m *Message) MarshalSSZTo(buf []byte) (dst []byte, err error) {
	...
	// Field (3) 'Input'
	if m.Input == nil {
		m.Input = new(types.ConsensusInput)
	}
...
func (m *Message) UnmarshalSSZ(buf []byte) error {
	...
	if err = m.Input.UnmarshalSSZ(buf[68:68]); err != nil {
		return err
	}

	// Field (4) 'PreparedRound'
	m.PreparedRound = ssz.UnmarshallUint64(buf[68:76])
...
func (s *SignedMessage) UnmarshalSSZ(buf []byte) error {
	...
	// Offset (1) 'Signers'
	if o1 = ssz.ReadOffset(buf[76:80]); o1 > size {
	...
	// Field (2) 'Signature'
	copy(s.Signature[:], buf[80:176])

	// Offset (3) 'RoundChangeJustifications'
	if o3 = ssz.ReadOffset(buf[176:180]); o3 > size || o1 > o3 {
		return ssz.ErrOffset
	}

	// Offset (4) 'ProposalJustifications'
	if o4 = ssz.ReadOffset(buf[180:184]); o4 > size || o3 > o4 {
		return ssz.ErrOffset
	}
